package com.henrique.desafioback.api.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, detail).mensagemUsuario(detail).fields(problemFields)
				.build();
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
		...
		Problem problem = createProblemBuilder(status, problemType, detail).mensagemUsuario(detail).build();
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		Problem problem = createProblemBuilder(status, problemType, detail).mensagemUsuario(MSG_ERRO_GENERICA_USUARIO_FINAL)
				.build();
